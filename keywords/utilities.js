const { AccessibilityHandler } = require('../utils/accessibility-handler');
...
*/
   ...
   * @param {*} testInfo 
   */
  async startAccessiblityAudit(testInfo, URL = null) {
    if (URL != null) {
      await this.page.goto(URL);
      console.log(`The ${URL} is ready for accessibility Audit`)
    }
    const accessibility = await new AccessibilityHandler(this.page);
    await accessibility.trackViolations(testInfo, null)
  }
}
